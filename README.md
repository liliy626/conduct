...
UNIVERSAL_HUB_GA_ENABLED=1
UNIVERSAL_HUB_PLAN_CACHE_ENABLED=1
SCHOOL_SCHEMA_INDEX_ENABLED=1
POLICY_VECTOR_ENABLED=1
GATEWAY_WEB_SEARCH_ENABLED=1
```

`UNIVERSAL_HUB_GA_ENABLED=1` 是服务器版 A/B 轨入口开关：
A 轨先命中高频问题 Plan Cache，B 轨继续承接 Universal Hub 的多模态资产生成。
